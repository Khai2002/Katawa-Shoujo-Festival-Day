init python:
    seen_school_stalls1_7h_0 = False
...
label school_stalls1:
    ...
    # Script ============
    if not seen_school_stalls1_7h_0:
        call school_stalls1_7h_0
...
label school_stalls1_7h_0:
    $ seen_school_stalls1_7h_0 = True
